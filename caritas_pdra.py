...
class CaritasPDRA:
    ...
    def _create_caritas_pdra_summary_risk_action(self):
        ...
        self.add_action(
            icon,
            text=self.tr(u'Statistics on Hazard, Vulnerability, Capacity, and Risk Computed from PDRA Data (gpkg-version)'),
            status_tip=self.tr(u'Statistics on Hazard, Vulnerability, Capacity, and Risk Computed from PDRA Data (gpkg-version)'),
            whats_this=self.tr(u'Statistics on Hazard, Vulnerability, Capacity, and Risk Computed from PDRA Data (gpkg-version)'),
